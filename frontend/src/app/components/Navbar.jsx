  ...
  return (
    <>
      ...
      >
        ...
        >
          SNI
          <span className="group-hover:text-white transition-colors">TCH</span>
        </Link>
            ...
            <div className="flex items-center gap-3">
              <Link to="/profile" className="flex items-center gap-2.5 group">
                <div className="hidden md:flex flex-col items-end">
                  ...
                  <span className="text-[7px] tracking-[0.2em] uppercase text-[#ffd700] opacity-60">
                    Gilded
                  </span>
                </div>
                <div className="w-8 h-8 rounded-full border border-[#4d4732] flex items-center justify-center overflow-hidden group-hover:border-[#ffd700] transition-all bg-[#0e0e0e]">
                  {user.profilePic ? (
                    ...
                    <span
                      className="text-[12px] font-black text-[#ffd700]"
      ...
      <aside
        ...
        style={{
          background: "#0e0e0e",
          borderRight: "1px solid rgba(77,71,50,0.3)",
        }}
      >
        {/* Sidebar Header */}
        ...
        {user && (
          <div
            className="px-6 py-5 border-b border-[#4d4732]/20"
            ...
            <Link to="/profile" className="flex items-center gap-3 group">
              <div className="w-10 h-10 rounded-full border border-[#4d4732] flex items-center justify-center overflow-hidden group-hover:border-[#ffd700] transition-all bg-[#0e0e0e]">
                {user.profilePic ? (
                  ...
                  <span
                    className="text-[14px] font-black text-[#ffd700]"
                    style={{ fontFamily: "Manrope, sans-serif" }}
                  >
                    {user.fullname?.charAt(0)}
                  </span>
              ...
              <div>
                <p className="text-[11px] font-black uppercase text-[#e5e2e1] tracking-wide">
                  MT. {user.fullname?.split(" ")[0]}
                </p>
                <p className="text-[8px] tracking-[0.2em] uppercase text-[#ffd700] opacity-70">
                  Gilded Member
                </p>
              </div>
            </Link>
        ...
        <nav className="flex flex-col px-6 py-6 gap-1 flex-1">
          {[
            ...
            <Link
              ...
              to={link.to}
              className="relative py-3 text-[11px] tracking-[0.25em] uppercase font-bold border-b border-[#4d4732]/20 text-[#e5e2e1] hover:text-[#ffd700] transition-colors"
            >
              {" "}
              {link.label}{" "}
              {link.label === "My Orders" && hasUnreadOrders && (
                <span className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-red-500" />
              )}{" "}
            </Link>
          ))}
        ...
        <div className="px-6 py-6 border-t border-[#4d4732]/30 space-y-4">
          ...
          <p className="text-[7px] tracking-[0.3em] uppercase opacity-20 text-center">
            © 2025 SNITCH
          </p>
        </div>
      </aside>
