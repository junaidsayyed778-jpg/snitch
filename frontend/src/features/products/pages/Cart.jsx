...
export default function Cart() {
  ...
  const handlePayment = async () => {
    try {
      ...
      const { razorpayOrderId, amount, currency } = data.paymentOrder;
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-2/3 space-y-10">
            <div className="flex items-center justify-between border-b border-[#4d4732]/30 pb-6">
              <h1
                className="text-3xl font-black uppercase tracking-tight text-[#e5e2e1]"
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
            ...
            <div className="space-y-8">
              {items.map((item, idx) => (
                ...
                >
                  {/* Image */}
                  <div
                    className="w-24 h-32 md:w-32 md:h-40 bg-[#1c1b1b] overflow-hidden rounded-sm flex-shrink-0 cursor-pointer"
            ...
            <div className="bg-[#1c1b1b] p-8 space-y-8 border border-[#4d4732]/20 sticky top-28">
              ...
              <div className="space-y-3 max-h-48 overflow-y-auto pr-2">
                {items.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex justify-between text-[9px] tracking-wider uppercase font-bold text-[#999077]"
                  >
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full py-5 bg-[#ffd700] text-[#131313] text-[10px] tracking-[0.3em] font-black uppercase hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50"
              >
